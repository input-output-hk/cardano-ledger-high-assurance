section \<open> Formalization of the UTxO transition system \<close>
...
subsection \<open> Property: No Double-Spending \<close>
...
subsection \<open> Property: UTxO is outputs minus inputs \<close>
...
subsection \<open> Property: Money supply is constant in the system \<close>
